...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> ids = Stream.iterate(1, i -> i + 1).limit(preparedData.size()).toList();
        ...
        System.out.printf("%s:\t%d ms\n", "Redis", Duration.between(startRedis, stopRedis).toMillis());
        System.out.printf("%s:\t%d ms\n", "MySQL", Duration.between(startMysql, stopMysql).toMillis());

        System.out.printf("%s:\t%d sec\n", "Redis", Duration.between(startRedis, stopRedis).toSeconds());
        System.out.printf("%s:\t%d sec\n", "MySQL", Duration.between(startMysql, stopMysql).toSeconds());
